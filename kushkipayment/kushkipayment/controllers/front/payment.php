...
class KushkiPaymentPaymentModuleFrontController extends ModuleFrontController
{
	...
	public function initContent()
	{
		...
		$this->context->smarty->assign(array(
			...
			'kushki_environment'    => ( Configuration::get( 'KUSHKI_TEST' ) ) ? 'https://uat.aurusinc.com/kushki/kushki/kushki-checkout.js' : 'https://p1.kushkipagos.com/kushki/kushki/kushki-checkout.js',
